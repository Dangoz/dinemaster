...
var PostModel = /** @class */ (function () {
    ...
    PostModel.prototype.createPost = function (postData, id) {
        return __awaiter(this, void 0, void 0, function () {
            var newPost;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._prisma.post.create({
                            data: {
    ...
    PostModel.prototype.getUserPosts = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var posts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._prisma.post.findMany({
                            where: { userId: userId },
                            orderBy: {
                                createdAt: 'desc'
                            }
    ...
    PostModel.prototype.getPostsRecent = function () {
        return __awaiter(this, void 0, void 0, function () {
            var posts;
            return __generator(this, function (_a) {
                switch (_a.label) {
